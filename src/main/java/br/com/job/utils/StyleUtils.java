...
//  LOGIN SCREEN
    ...
    final public static String JOB_LABEL = "-fx-font-size: 24px;" +
            "-fx-text-fill: #FFF;" +
            "-fx-font-family: 'Times New Roman';";

    final public static String WLCM_LABEL = "-fx-font-size: 36px;" +
            " -fx-text-fill: #FFF;" +
            " -fx-font-family: 'Times New Roman';";

    final public static String BTN_LOGIN = "-fx-background-color: #16ED5E;" +
            "-fx-font-weight: bold;";
